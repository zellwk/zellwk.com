/* PrismJS 1.23.0
https://prismjs.com/download.html?#themes=prism&languages=markup+css+clike+javascript+autohotkey+bash+css-extras+diff+editorconfig+graphql+json+jsstacktrace+js-templates+nginx+jsx+scss+shell-session+toml+twig+typescript+yaml&plugins=diff-highlight */
var _self =
