...
Note: Results are from Firefox's Devtools. Read [this](/blog/performance-now) to understand why I'm only benchmarking against the Firefox browser.
...
The average results are summarised in the following table:
