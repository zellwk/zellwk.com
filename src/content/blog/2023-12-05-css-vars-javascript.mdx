...
tags: [css, javascript, splendidlabz]
pubDate: 2023-12-05
---
...
- [`getCSSVar`](https://splendidlabz.com/docs/utils/dom/css-variables/) — Gets CSS variable from an element
- [`setCSSVar`](https://splendidlabz.com/docs/utils/dom/css-variables/) — Sets CSS variable on an element
...
```shell
npm install @splendidlabz/utils --save
```

```js
import { getCSSVar, setCSSVar } from '@splendidlabz/utils/dom'
```
...
- [`getCSSVar` documentation](https://splendidlabz.com/docs/utils/dom/css-variables/)
- [`setCSSVar` documentation](https://splendidlabz.com/docs/utils/dom/css-variables/)
