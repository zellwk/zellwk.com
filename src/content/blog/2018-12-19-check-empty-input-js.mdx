...
<Image
  src="/src/assets/2018/empty-input-validation-js/check.gif"
...
<Image
  src="/src/assets/2018/empty-input-validation-js/problem.gif"
  alt="Form becomes invalid when empty after user types into it"
/>
...
<Codepen
  height="476"
  link="https://codepen.io/zellwk/pen/EObQpr"
  title="Empty validation with JavaScript"
/>
