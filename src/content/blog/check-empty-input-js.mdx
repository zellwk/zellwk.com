...
<Image
  src="/assets/2018/empty-input-validation-js/check.gif"
...
<Image
  src="/assets/2018/empty-input-validation-js/problem.gif"
...
<Codepen height="476" hash="EObQpr" title="Empty validation with JavaScript" />
