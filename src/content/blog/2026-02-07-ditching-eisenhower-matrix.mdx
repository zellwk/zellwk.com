...
description: "Why I stopped using the Eisenhower Matrix after a decade, and the 7 factors I now use to decide what to work on next."
tags: ['reflections', 'choices', 'life']
---
...
<Image
  src="/src/assets/blog/eisenhower/eisenhower.png"
