...
<Codepen height="370" link="https://codepen.io/zellwk/pen/XPyGZp" title="XPyGZp" />
...
<p
  data-height="300"
  data-theme-id="7929"
  data-slug-hash="dqQrmm"
  data-default-tab="result"
  data-user="zellwk"
  data-pen-title="Explicit Grid properties"
  class="codepen"
>
  See the Pen{' '}
  <a href="https://codepen.io/zellwk/pen/dqQrmm/">Explicit Grid properties</a>{' '}
...
<Codepen link="https://codepen.io/zellwk/pen/OoaqoG" title="Positioning items (rows)" />
...
<Codepen link="https://codepen.io/zellwk/pen/PdxLyg" title="Grid-template-area" />
...
<Codepen link="https://codepen.io/zellwk/pen/bxQZZG" title="Explicit Grid with gap" />
...
When you `justify` something, you're changing the alignment according to the _inline-axis_. When you `align` something, you're changing the alignment according to the _block-axis_.
...
<Image
  src="/src/assets/2018/remember-css-grid-properties/axes.png"
  caption="Inline-axis reads left to right. Block-axis reads top to bottom"
/>
...
<Image
  src="/src/assets/2018/remember-css-grid-properties/alignment-values.png"
  caption="7 possible alignment values and what they do"
/>
...
<Image
  src="/src/assets/2018/remember-css-grid-properties/alignment-values-2.png"
  alt="4 possible alignment values and what they do"
  caption="4 possible alignment values and what they do"
/>
...
<Codepen link="https://codepen.io/zellwk/pen/yxQrJb" title="Implicit grid" />
