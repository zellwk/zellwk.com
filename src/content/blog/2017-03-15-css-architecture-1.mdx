...
<p
  data-height="265"
  data-theme-id="dark"
  data-slug-hash="XMaGYb"
  data-default-tab="html,result"
  data-user="zellwk"
  data-embed-version="2"
  data-pen-title="XMaGYb"
  class="codepen"
>
  See the Pen <a href="http://codepen.io/zellwk/pen/XMaGYb/">XMaGYb</a> by Zell
...
<Image
  src="/src/assets/2017/css-architecture/container.png"
  alt="Image of a block that contains a background that bleeds out of it"
  caption="The greyish background bleeds out of alignment"
/>
