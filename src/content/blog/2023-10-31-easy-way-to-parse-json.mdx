...
description: Tired of writing try/catch blocks every time you parse JSON? Here's a one-line helper that handles errors and default values for you.
tags: [splendidlabz, javascript]
pubDate: 2023-10-31
---
...
I think this process can be simplified so I created a helper function, [`parseJSON`](https://splendidlabz.com/utils/parse-json) that lets you do these two things in a single line:
...
You can use `parseJSON` by first installing [Splendid UI](https://splendidlabz.com).
...
- [`parseJSON` documentation](https://splendidlabz.com/utils/parse-json)
