...
<Image src="/src/assets/2019/brew/search.png" alt="Brew search." />
...
<Image src="/src/assets/2019/brew/link.png" alt="Linking Node 10." />
...
<Image
  src="/src/assets/2019/brew/link-force.png"
...
<Image
  src="/src/assets/2019/brew/version.png"
  alt="Checking for Node version."
/>
Notice its Node is now v10.16.3. Unfortunately, with Homebrew, we don't get to
use [Semantic Versioning][4] with Homebrew, so you can't install specific
versions. You can only perform major version upgrade/downgrades.
...
<Image
  src="/src/assets/2019/brew/undo.png"
