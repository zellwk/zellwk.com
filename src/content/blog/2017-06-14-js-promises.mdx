...
description: 'Promises in JavaScript explained: Async operations made simple. Learn resolve, reject, and promise chains.'
tags: [javascript]
...
<Image src="/src/assets/2017/promises/pending.png" alt="Logging jeffBuysCake shows that the promise is pending." caption="Logging jeffBuysCake shows that the promise is pending." />
...
<Image src="/src/assets/2017/promises/hascake.png" alt="The console shows either black forest cake or no cake, depending on what you pass into jeffBuysCake." caption="The console shows either black forest cake or no cake, depending on what you pass into jeffBuysCake." />
