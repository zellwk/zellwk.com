...
description: 'CSS Transitions explained: Timing functions, cubic-bezier, multiple properties. Smooth animation guide.'
tags: [css, animation]
pubDate: 2017-12-13
---
...
<Codepen
  height="400"
  link="https://codepen.io/zellwk/pen/Qqzzxd"
...
<Codepen
  height="400"
  link="https://codepen.io/zellwk/pen/GMPPBg"
  title="CSS Transition with JavaScript"
/>
...
<Codepen
  height="700"
  link="https://codepen.io/zellwk/pen/Oxrqpo"
  title="CSS Transition Timing Functions (no cubic)"
/>
...
<Image
  src="/src/assets/2017/css-transition/cubic-bezier.png"
  alt="Both Chrome and Firefox provides you with a cubic-bezier tool"
  caption="Both Chrome and Firefox provides you with a cubic-bezier tool"
/>

<Codepen
  height="800"
  link="https://codepen.io/zellwk/pen/gGZqNo"
  title="CSS Transition Timing Functions"
/>
...
<Codepen
  height="400"
  link="https://codepen.io/zellwk/pen/GOLLyR"
  title="CSS Transition (different transition speeds when transitioning in and out)"
/>
