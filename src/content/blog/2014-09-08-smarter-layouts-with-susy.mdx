...
<Image
  src="/src/assets/2014/09/content-sidebar.png"
  alt="Basic Content - Sidebar Layout"
/>
...
<div class="wrap">
  <div class="content-sidebar">
    <div>Content</div>
    <!-- If you want a class, replace with -->
    <div>Sidebar</div>
    <!-- <div class="susy-grid-item"> * </div>-->
  </div>
</div>
```
...
<Image
  src="/src/assets/2014/09/mixpanel-tablet.png"
  alt="Mixpanel Blog Layout when viewed on a tablet"
/>

and on a desktop sized viewport:

<Image
  src="/src/assets/2014/09/mixpanel-desktop.png"
  alt="Mixpanel Blog Layout when viewed on a desktop"
/>
...
<div class="wrap">
  <div class="blog-list">
    <div>Item</div>
    <!-- We can make this large with CSS pseudo classes -->
    <div>Item</div>
    <div>Item</div>
    <div>Item</div>
    <div>Item</div>
...
<p
  data-height="266"
  data-theme-id="7929"
  data-slug-hash="rufmH"
  data-default-tab="result"
  data-user="zellwk"
  class="codepen"
>
  See the Pen <a href="http://codepen.io/zellwk/pen/rufmH/">rufmH</a> by Zell
