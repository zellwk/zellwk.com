...
description: "Stop freezing at blank files: Break problems down, solve them step-by-step, then refactor. Overcome coder's block with proven thinking strategies."
---
...
<Youtube id="B6EZIEqO15w" title="How to debug Javascript errors" />
...
<Image
  src="/src/assets/2017/think/ele-in-fridge.jpg"
  alt="Image of an elephant in the fridge"
  caption="Poor elephant. It looks so sad in the fridge :("
/>
...
<Codepen
  link="https://codepen.io/zellwk/pen/zdqmLe"
  title="Sidebar for Thinking like a programmer article"
/>
