...
description: 'Console.log for debugging: Learn by trial and error. Ultimate skill for JavaScript debugging.'
...
<Youtube id='rBHzRjJSQbI' title='Console.log everything!' />
