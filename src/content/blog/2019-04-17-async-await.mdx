...
slug: async-await
series: async-await
tags: [asyncjs, javascript, magicaldevs]
pubDate: 2019-04-17
...
<Image src="/src/assets/2019/async-await/sleep.gif" alt="Console logs 'now' immediately. One second later, it logs 'After one second'"/>
...
<Image src="/src/assets/2019/async-await/block-1.gif" alt="Console logs 'Now' immediately. After one second, console logs 1"/>
...
<Image src="/src/assets/2019/async-await/block-2.gif" alt="Console shows 'Now' immediately. One second later, it shows 1. Another second later, it shows 2. Another second later, it shows 3 and 'Done' at the same time."/>
...
<Image src="/src/assets/2019/async-await/block-3.gif" alt="Console shows 'Now' immediately. After one second, console shows 1, 2, 3, and 'Done'."/>
