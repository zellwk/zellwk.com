...
<Image
  src="/assets/2018/simple-form-css-grid/form.png"
...
<Image
  src="/assets/2018/simple-form-css-grid/grid1.png"
...
<Codepen hash="qMLErJ" title="Simple form with CSS Grid" />
...
<Image
  src="/assets/2018/simple-form-css-grid/smiley.png"
...
<Image
  src="/assets/2018/simple-form-css-grid/align-items.png"
  caption="Items can be aligned differently if you set `align-items` to a different value"
/>

Here's a Codepen for you to play:

<Codepen hash="jvXEzm" title="Simple form with CSS Grid (with SVG Button)" />
