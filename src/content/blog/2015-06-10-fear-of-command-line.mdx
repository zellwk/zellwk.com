...
<Image src="/src/assets/2015/06/command-line.png" alt="command line" />
...
<Image src="/src/assets/2015/06/invalid-command.png" alt="invalid-command" />
...
<Image src="/src/assets/2015/06/pwd.png" alt="pwd" />
...
<Image src="/src/assets/2015/06/ls.png" alt="ls" />
...
<Image src="/src/assets/2015/06/cd.png" alt="cd" />
...
<Image src="/src/assets/2015/06/cd2.png" alt="cd back a directory" />
...
<Image src="/src/assets/2015/06/cd-drag.gif" alt="cd with drag" />
...
<Image src="/src/assets/2015/06/mkdir.png" alt="mkdir" />
...
<Image src="/src/assets/2015/06/touch.png" alt="touch" />
...
<Image src="/src/assets/2015/06/clear.png" alt="clear" />
...
<Image src="/src/assets/2015/06/git1.png" alt="Invalid command git" />

Let's look at it part by part so it's not so overwhelming. Here's the first part:

<Image src="/src/assets/2015/06/git2.png" alt="git usage" />
...
<Image src="/src/assets/2015/06/git3.png" alt="Git commands" />
...
<Image src="/src/assets/2015/06/git4.png" alt="git4" />
