...
<Image
  src="/src/assets/2018/empty-input-validation-css/autocomplete.gif"
  alt="autocomplete demo from https://learnjavascript.today"
/>
...
<Image
  src="/src/assets/2018/empty-input-validation-css/check.gif"
  alt="when input is filled, borders should turn green"
/>
...
<Image
  src="/src/assets/2018/empty-input-validation-css/check.gif"
  alt="borders turned green when input is filled"
/>

But there's a problem: If the user enters a whitespace into the field, the borders turn green too.

<Image
  src="/src/assets/2018/empty-input-validation-css/check-whitespace.gif"
  alt="Borders turn green even if user enters a whitespace"
/>
...
<Image
  src="/src/assets/2018/empty-input-validation-css/check-pattern-pre1.gif"
  alt="Input doesn't get validated when whitespaces are entered"
/>

But when a whitespace is entered (anywhere) into the input, the input gets invalidated.

<Image
  src="/src/assets/2018/empty-input-validation-css/check-pattern1.gif"
  alt="Borders turned from greet to black when a whitespace is added."
/>
...
<Image
  src="/src/assets/2018/empty-input-validation-css/autocomplete.gif"
  alt="Dropdown contains countries with names that have spaces in them. For example, United States."
/>
...
<Image
  src="/src/assets/2018/empty-input-validation-css/check-pattern2.gif"
  alt="Borders remained green when whitespace is added in the middle of the input"
/>

But there's one more problem... the input doesn't validate if you START with a whitespace...

<Image
  src="/src/assets/2018/empty-input-validation-css/check-pattern3.gif"
  alt="Borders turned black when whitespace is added to the start of input"
/>
...
<p
  data-height="486"
  data-theme-id="7929"
  data-slug-hash="dgEKxX"
  data-default-tab="result"
  data-user="zellwk"
  data-pen-title="Pure CSS Empty validation"
  class="codepen"
>
  See the Pen{' '}
  <a href="https://codepen.io/zellwk/pen/dgEKxX/">Pure CSS Empty validation</a>{' '}
...
>
  See the Pen{' '}
  <a href="https://codepen.io/zellwk/pen/NeRaPw/">Pure CSS Empty validation</a>{' '}
  by Zell Liew (<a href="https://codepen.io/zellwk">@zellwk</a>) on{' '}
  <a href="https://codepen.io">CodePen</a>.
</p>
<script async src="https://static.codepen.io/assets/embed/ei.js"></script>
