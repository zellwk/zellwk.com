...
<Image src="/src/assets/2014/09/selectivizr.png" alt="" />
...
If you are only going to be using `nth-child` and `last-child` like what we have done previously when writing [smarter HTML layouts](/blog/smarter-layouts-with-susy/), jQuery is plenty enough. Let's work with jQuery for this tutorial.
