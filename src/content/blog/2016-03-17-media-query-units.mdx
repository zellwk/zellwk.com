...
description: 'Media query units compared: Px vs em vs rem tested. Em wins for zoom and accessibility. Browser compatibility results revealed.'
ckForm: css
tags: [css]
pubDate: 2016-03-17
---
...
<Image
  src="/src/assets/2016/media-query-units/control.gif"
  alt="The Base Experiment"
/>
...
<Image
  src="/src/assets/2016/media-query-units/chrome.gif"
  alt="Results from Chrome, Firefox and Internet Explorer 11 for scenario 1"
/>
...
<Image
  src="/src/assets/2016/media-query-units/safari-200.gif"
  alt="Results from Safari for scenario 1"
/>
...
<Callout>
  The original idea behind `em` based sizes was due to older browsers not being
  able to update pixel values when a user zooms. In this regard, testing the
  difference between media query units when a user zooms will help to answer the
  question on whether we can use `px` based media queries now.
</Callout>

<Image src="/src/assets/2016/media-query-units/zoom.gif" alt="User zooms in" />
...
<Image
  src="/src/assets/2016/media-query-units/chrome-zoom.gif"
  alt="Results from Chrome, Firefox and Internet Explorer 11 in scenario 2"
/>

And you guessed it... Safari didn't :(

<Image
  src="/src/assets/2016/media-query-units/safari-zoom.gif"
  alt="Results from Safari in scenario 2"
/>
...
<Image
  src="/src/assets/2016/media-query-units/chrome-very-large-font-size.gif"
  alt="Results from all browsers for scenario 3"
/>
...
Let's call the viewport smaller than 600px the _small viewport_, while that larger than 600px the _medium viewport_.
