...
description: 'Master DOM traversal in JavaScript: Efficiently select elements downwards, upwards, sideways. Better than document.querySelector every time.'
tags: [javascript]
...
<Image
  src="/src/assets/2018/traversal/children.png"
  alt="Selecting all list items with the children property"
  caption="Selecting all list items with the children property"
/>
...
<Image
  src="/src/assets/2018/traversal/specific-child.png"
  alt="Select a specific child with [index]"
  caption="Select a specific child with [index]"
/>
