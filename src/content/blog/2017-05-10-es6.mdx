...
<Image src="/images/2017/es6/loop-wrong.png" alt="i was logged as 5 four times in the timeout function" caption="i was logged as 5 four times in the timeout function" />
...
<Image src="/images/2017/es6/loop-right.png" alt="i was correctly logged as 1, 2 3 and 4" caption="i was correctly logged as 1, 2 3 and 4" />
...
<Image src="/images/2017/es6/window.png" alt="This defaults to window object in browsers" caption="This defaults to window object in browsers" />
...
<Image src="/images/2017/es6/object.png" alt="This refers to the object when the function is called in an object method." caption="This refers to the object when the function is called in an object method." />
...
<Image src="/images/2017/es6/constructor.png" alt="This refers to the constructed object called with the new keyword or Object.create()." caption="This refers to the constructed object called with the new keyword or Object.create()." />
...
<Image src="/images/2017/es6/arguments.png" alt="Arguments is a Symbol, not an array" caption="Arguments is a Symbol, not an array" />
...
<Image src="/images/2017/es6/dancing.gif" alt="Happy, dancing star wars figure" caption="Wheeeee! Happy! :)" />
...
<Image src="/images/2017/es6/multiline.png" alt="Multi-line strings!" caption="Multi-line strings works! Woot!" />
