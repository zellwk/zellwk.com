...
description: "A workaround to use Codekit 2's built-in Autoprefixer alongside Compass by manually adding Compass Sass files to your project."
tags: [css, tools]
...
I only wanted to use vertical rhythms with autoprefixer when I resorted to looking for this hack. I've wrote about how to use vertical rhythms previously [here](/blog/compass-vertical-rhythm/)
...
<Image src="/src/assets/2014/05/codekit.png" alt="" />
...
<Image src="/src/assets/2014/05/codekit-2.png" alt="" />

You can find autoprefixer's settings under `Languages > Special Languages Tool`.

<Image src="/src/assets/2014/05/codekit-3.png" alt="" />
