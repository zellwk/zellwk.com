...
<Image src='/images/2015/06/command-line.png' alt='command line' />
...
<Image src='/images/2015/06/invalid-command.png' alt='invalid-command' />
...
<Image src='/images/2015/06/pwd.png' alt='pwd' />
...
<Image src='/images/2015/06/ls.png' alt='ls' />
...
<Image src='/images/2015/06/cd.png' alt='cd' />
...
<Image src='/images/2015/06/cd2.png' alt='cd back a directory' />
...
<Image src='/images/2015/06/cd-drag.gif' alt='cd with drag' />
...
<Image src='/images/2015/06/mkdir.png' alt='mkdir' />
...
<Image src='/images/2015/06/touch.png' alt='touch' />
...
<Image src='/images/2015/06/clear.png' alt='clear' />
...
<Image src='/images/2015/06/git1.png' alt='Invalid command git' />

Let's look at it part by part so it's not so overwhelming. Here's the first part:

<Image src='/images/2015/06/git2.png' alt='git usage' />
...
<Image src='/images/2015/06/git3.png' alt='Git commands' />
...
<Image src='/images/2015/06/git4.png' alt='git4' />
