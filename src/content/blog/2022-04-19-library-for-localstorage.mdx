...
tags: [javascript]
pubDate: 2022-04-19
description: Make localStorage simpler with the localStore library. Handle JSON serialization automatically and manage cookie expiry without boilerplate.
---
