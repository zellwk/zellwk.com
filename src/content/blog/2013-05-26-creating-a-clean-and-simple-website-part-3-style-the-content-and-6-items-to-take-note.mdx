...
description: "How to style the content section of your website — covering text, font styles, links, images, lists, and blockquotes."
tags: [css, design]
...
All of the above items are extremely important and could break a blog post if they are not properly styled. (Honestly, I forgot to style **`<strong>`** and _`<em>`_ tags and discovered that none of my text were bold when I used them. Not fun, and I don't think you'll want that to happen to you.)
...
Closely linked with text are font styles and weights. I mentioned earlier that I totally missed these two things and had wondered why my text couldn't be **bolded** nor _italicised_. This was simply because I didn't remember to style the `strong` and `em` tags.
