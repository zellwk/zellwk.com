...
<Image src="/src/assets/blog/astro-fancy-list-item/markdown.png" alt="List items written like normal markdown" caption="Input: Contains normal markdown" />

<Image src="/src/assets/blog/astro-fancy-list-item/output.png" alt="Output that uses SVGs as the list bullet" caption="Output: Contains an SVG as the list item"/>
...
<Image src="/src/assets/blog/astro-fancy-list-item/green-star.png" alt="List items with a green color star" />

<Image src="/src/assets/blog/astro-fancy-list-item/blue-star.png" alt="List items with a blue color star" />

<Image src="/src/assets/blog/astro-fancy-list-item/yellow-star.png" alt="List items with a yellow color star" />
...
<Image src="/src/assets/blog/astro-fancy-list-item/html-string.png" alt="console.log of the slot content" />
