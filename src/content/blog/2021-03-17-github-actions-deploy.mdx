...
tags: [devops, github actions, tooling]
pubDate: 2021-03-17
---
...
<Image
  src="/src/assets/2021/github-actions-deploy/use-legacy-command.png"
  alt="use legacy command"
/>
...
<Image
  src="/src/assets/2021/github-actions-deploy/name-ssh-key-file.png"
  alt="name ssh key file"
/>
...
<Image
  src="/src/assets/2021/github-actions-deploy/passphrase-empty.png"
  alt="leave passphrase empty"
/>

When you're done generating your SSH keys you should get a cute image like this:

<Image
  src="/src/assets/2021/github-actions-deploy/ssh-key-randomart.png"
  alt="ssh key randomart image"
/>
...
<Image
  src="/src/assets/2021/github-actions-deploy/public-key-extension.png"
  alt="public key has extension .pub"
/>
...
<Image
  src="/src/assets/2021/github-actions-deploy/github-settings-location.png"
  alt="github settings navigation location"
/>

<Image
  src="/src/assets/2021/github-actions-deploy/github-secrets-location.png"
  alt="github secrets navigation location"
/>

<Image
  src="/src/assets/2021/github-actions-deploy/new-repository-secret-button.png"
  alt="new repository secret button location"
/>
...
<Image
  src="/src/assets/2021/github-actions-deploy/adding-a-secret.png"
  alt="adding a new repository secret"
/>
...
<Image
  src="/src/assets/2021/github-actions-deploy/private-key.png"
  alt="github actions private key"
/>

We need to copy everything and paste it inside the Secret value

<Image
  src="/src/assets/2021/github-actions-deploy/paste-secret-value.png"
  alt="paste private key inside secret value"
/>
...
<Image
  src="/src/assets/2021/github-actions-deploy/ssh-private-key.png"
  alt="saved secret ssh-private-key"
/>
...
<Image
  src="/src/assets/2021/github-actions-deploy/known-hosts-file.png"
  alt="opened known hosts file"
/>
...
<Image
  src="/src/assets/2021/github-actions-deploy/add-ip-address.png"
  alt="inserted ip address result"
/>

Once we know this, we can manually add the IP address (which I named as `SSH_HOST`) into the Github Secrets.

<Image
  src="/src/assets/2021/github-actions-deploy/add-ip-github-secrets.png"
  alt="add IP address to github secrets"
/>
...
<Image
  src="/src/assets/2021/github-actions-deploy/list-of-resources.png"
  alt="list of resources copied via rsync"
/>
...
[here](https://gist.github.com/zellwk/c621f73a3c75ac964f56f0c811d7ec80)
