...
<Image src="/src/assets/2021/reduce/sum-flow1.png" caption="Initial value set to 0" />

`accumulator` will be `initialValue` in the first iteration. `currentValue` will be the first array item.

<Image src="/src/assets/2021/reduce/sum-flow2.png" caption="accumulator assigns as 0" />

<Image src="/src/assets/2021/reduce/sum-flow3.png" caption="currentValue is the first item in the array" />
...
<Image src="/src/assets/2021/reduce/sum-flow4.png" caption="The next return value is calculated" />

`accumulator` takes on the returned value in the second iteration. `currentValue` will be the second array item.

<Image src="/src/assets/2021/reduce/sum-flow5.png" caption="The previous return value is used as the next accumulator" />

<Image src="/src/assets/2021/reduce/sum-flow6.png" caption="currentValue becomes the second item in the array" />
...
<Image src="/src/assets/2021/reduce/sum-flow7.png" caption="The return value is calculated and the process repeats" />
