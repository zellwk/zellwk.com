...
<Image src="/assets/2019/local-mongodb/version.png" alt="Terminal showing MongoDB Version"/>
...
<Image src="/assets/2019/local-mongodb/mongod.png" alt=""/>
...
<Image src="/assets/2019/local-mongodb/mongo-shell.png" alt=""/>
...
<Image src="/assets/2019/local-mongodb/test-db.png" alt="Terminal returns 'test' when we run the 'db' command."/>
...
<Image src="/assets/2019/local-mongodb/switch-db.png" alt="Switch to a database named game-of-thrones."/>
...
<Image src="/assets/2019/local-mongodb/insert-1.png" alt="Added 'Jon Snow' into the 'characters' collection."/>
...
<Image src="/assets/2019/local-mongodb/insert-2.png" alt="Added 'Arya Stark' into the 'characters' collection."/>
...
<Image src="/assets/2019/local-mongodb/db-find.png" alt="Database returns two characters—Jon Snow and Arya Stark."/>
...
<Image src="/assets/2019/local-mongodb/mongodb-compass.png" alt="MongoDB Compass startup screen."/>
...
<Image src="/assets/2019/local-mongodb/mongodb-compass-settings.png" alt="Sets Hostname to localhost and Port to 27017."/>
...
<Image src="/assets/2019/local-mongodb/mongodb-compass-databases.png" alt="List of databases in my local MongoDB"/>

If you click on `game-of-thrones`, you'll see a `characters` collection.

<Image src="/assets/2019/local-mongodb/mongodb-compass-collection.png" alt="The characters collection in MongoDB Compass."/>

And if you click on `characters`, you'll see the two characters we created in the earlier section.

<Image src="/assets/2019/local-mongodb/mongodb-compass-documents.png" alt="Documents 'Jon Snow' and 'Arya Stark' in the 'Characters' collection."/>
...
<Image src="/assets/2019/local-mongodb/connect-mongodb.png" alt="Connected to local MongoDB with MongoDB native driver."/>
...
<Image src="/assets/2019/local-mongodb/connect-mongoose.png" alt="Connected to local MongoDB through Mongoose."/>
