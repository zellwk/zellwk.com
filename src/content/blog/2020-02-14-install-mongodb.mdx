...
<Image
  src="/src/assets/2020/install-mongodb/start.png"
  alt="Started MongoDB with brew services"
/>

<Callout>
  You can use `start` instead of `run`. `start` will start MongoDB automatically
  when you login into your Macbook. I prefer `run` since I don't want MongoDB to
...
<Image
  src="/src/assets/2020/install-mongodb/list.png"
  alt="Mongodb-community has status set to started."
/>
...
<Image
  src="/src/assets/2020/install-mongodb/mongo-shell.png"
  alt="Starts the Mongo shell."
/>
...
<Image src="/src/assets/2020/install-mongodb/stop.png" alt="Stopped MongoDB" />
