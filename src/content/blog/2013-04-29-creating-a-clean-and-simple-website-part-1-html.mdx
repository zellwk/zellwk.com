...
description: "A step-by-step walkthrough of writing the HTML for a website, covering elements, IDs, classes, and the overall document structure."
tags: [design, css]
...
<div id="sidebar">
  <div class="widget-wrap">
    ...
    <h4 class="widgettitle">Title of sidebar item</h4>
    <p>Sidebar item text</p>
  </div>
</div>
```
...
<div id="footer" class="footer">
  <div class="wrap">
    <div class="creds">
      <p>
        Copyright &#x000A9; 2013 &middot; <a href="#">Zell Liew</a> &middot;
        Built on the <a href="#">Genesis Framework</a>
      </p>
    </div>
  </div>
</div>
...
[i1]: /assets/2013/04/website.jpg 'Full Website Layout'
[1]: /blog/layouts-of-a-website 'Layout of your website'
[2]: /assets/2013/04/Website-HTML.html 'HTML Codes'
