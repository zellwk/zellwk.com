...
<Codepen height='370' hash='XPyGZp' title='XPyGZp' />
...
<Codepen hash='OoaqoG' title='Positioning items (rows)' />
...
<Codepen hash='PdxLyg' title='Grid-template-area' />
...
<Codepen hash='bxQZZG' title='Explicit Grid with gap' />
...
<Image
  src='/images/2018/remember-css-grid-properties/axes.png'
...
<Image
  src='/images/2018/remember-css-grid-properties/alignment-values.png'
...
<Image
  src='/images/2018/remember-css-grid-properties/alignment-values-2.png'
...
<Codepen hash='yxQrJb' title='Implicit grid' />
