...
<Image
  src="/src/assets/2020/wsl/window-features.png"
  alt="Searched for Turn Windows features on and off in the start menu."
/>

Next, scroll down and check Windows Subsystem for Linux. Restart your computer after checking this option.

<Image
  src="/src/assets/2020/wsl/window-features-wsl.jpg"
  alt="Checks the WSL option."
/>
...
<Image
  src="/src/assets/2020/wsl/ubuntu.png"
  alt="Ubuntu from the Microsoft store"
/>

Download the distribution, install it, and launch it.

<Image
  src="/src/assets/2020/wsl/ubuntu-installed.png"
  alt="Ubuntu Terminal after launching Ubuntu for the first time."
/>
...
<Image
  src="/src/assets/2020/wsl/wsl-installed.png"
  alt="Switched to WSL in Powershell."
/>
...
<Image
  src="/src/assets/2020/wsl/remote-wsl.png"
  alt="Remote WSL Extension in Visual Studio Code's markeplace."
/>
...
<Image
  src="/src/assets/2020/wsl/vscode-default-shell-1.png"
  alt="Selecting the Default Shell option in Visual Studio Code's integrated terminal"
/>

A listbox should pop up at the top. Select WSL Bash here.

<Image
  src="/src/assets/2020/wsl/vscode-default-shell-2.png"
  alt="Select WSL Bash from the popup menu."
/>
Restart Visual Studio Code and open the integrated terminal again. You should
see the same `/mnt/c` path as before.

<Image
  src="/src/assets/2020/wsl/vscode-default-shell-3.png"
  alt="Visual Studio Code Integrated Terminal shows the mount path."
/>
...
<Image
  src="/src/assets/2020/wsl/integrated-git-version.png"
  alt="Shows the version of Git installed in WSL."
/>
...
<Image
  src="/src/assets/2020/wsl/git-not-found.png"
  alt="Dialog that asks you to install Git."
/>
...
<Image
  src="/src/assets/2020/wsl/git-install-1.png"
  alt="Uncheck Git Explorer integration."
/>

<Image
  src="/src/assets/2020/wsl/git-install-2.png"
  alt="Set default editor to Visual Studio Code"
/>

<Image
  src="/src/assets/2020/wsl/git-install-3.png"
  alt="Use Window's default console window"
/>

Restart Visual Studio Code once you're done installing Windows Git. The Source Control Panel should work now.

<Image
  src="/src/assets/2020/wsl/git-vscode-installed.png"
  alt="Source Control panel shows the staging area."
/>
...
<Callout>
  I recommend creating an alias for the `cp` command above. It'll let you sync
  up your `.ssh` folders anytime.
</Callout>
...
<Image src="/src/assets/2020/wsl/cmder.png" alt="Started up Cmder." />
...
<Image
  src="/src/assets/2020/wsl/cmder-wsl.png"
  alt="Typed `wsl` into Cmder. Shell changed to WSL. "
/>
...
<Image
  src="/src/assets/2020/wsl/cmder-settings.png"
  alt="Location of the settings menu option."
/>

Under Startup, select "Specified name task". Then, select `{WSL::bash}`.

<Image
  src="/src/assets/2020/wsl/cmder-startup.png"
  alt="Location of the WSL bash option."
/>
