...
description: "Breaking changes coming to Splendid Layouts — combining it with Splendid Styles and switching from PascalCase to kebab-case for Tailwind v4 compatibility."
slug: splendid-labz-breaking-changes
tags: ['splendidlabz', 'css', 'tailwind']
pubDate: 2025-03-14
---
