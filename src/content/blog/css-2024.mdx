...
My explorations recently have been revolving around this area, primarily with [Splendid UI](https://splendid-ui.com) (for JavaScript and interactive elements) and [CSS Layout Patterns](https://magicaldevschool.com/css-layout-patterns) (for the way I write HTML and CSS).
