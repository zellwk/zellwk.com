...
<Image src="/images/2020/vscode-keybindings-1/mac-keyboard.jpg" alt="Mac keyboard." />

On my Windows PC (which is a Surface Laptop).

<Image src="/images/2020/vscode-keybindings-1/surface-keyboard.jpg" alt="Windows (Surface Laptop 3) keyboard" />
...
<Image src="/images/2020/vscode-keybindings-1/surface-keyboard-after.jpg" alt="Changed positions of Ctrl, Alt, and Win key on the Window's keyboard." />
...
<Image src="/images/2020/vscode-keybindings-1/go-to-file.gif" alt="Opens the quick open dropdown menu with Command + T." />
...
<Image src="/images/2020/vscode-keybindings-1/go-to-file.png" caption="Searched for Go to file (on Mac)" />
...
<Image src="/images/2020/vscode-keybindings-1/keybindings.png" alt="Green arrow pointing to an icon that opens the keybindings.json file." />
...
<Image src="/images/2020/vscode-keybindings-1/select-tab.gif" alt="Changes betwen three tabs with keyboard shortcuts." />
...
<Image src="/images/2020/vscode-keybindings-1/open-editor-at-index.png" alt="Searched for Open editor at index. Found 9 entries." />
...
<Video src="/images/2020/vscode-keybindings-1/create-code-panels.mp4" />
...
<Video src="/images/2020/vscode-keybindings-1/jump-panels.mp4" />
...
<Image src="/images/2020/vscode-keybindings-1/focus-editor-group.png" alt="Searched for focus editor group in Visual Studio Code keyboard shortcuts panel." />
...
<Video src="/images/2020/vscode-keybindings-1/move-panel.mp4" />

*Move editor into group* also lets me open up a panel if there are none.

<Video src="/images/2020/vscode-keybindings-1/move-open-panel.mp4" />

You can even create a Vertical + Horizontal split combination with *Move editor into group*!

<Video src="/images/2020/vscode-keybindings-1/move-open-panel-vertical.mp4" />
...
<Image src="/images/2020/vscode-keybindings-1/move-editor-into.png" alt="Searched for Move editor into in the keyboarh shortcuts panel." />
...
<Image src="/images/2020/vscode-keybindings-1/close.gif" alt="Closes an empty panel." />
...
<Image src="/images/2020/vscode-keybindings-1/toggle-split.gif" alt="Toggles split direction of panels" />
