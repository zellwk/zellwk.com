...
<Image src="/images/2020/vscode-sync/settings-sync.png" alt="Settings Sync in Visual Studio Code extension panel" />

<Image src="/images/2020/vscode-sync/login.png" alt="Points to a login with Github button." />

<Image src="/images/2020/vscode-sync/select-gist.png" alt="Selects a gist from a list of gists." />
...
<Image src="/images/2020/vscode-sync/keybindings-mac.png" alt="Mac key bindings uses a file called keyBindingsMac.json" />

<Image src="/images/2020/vscode-sync/keybindings-windows.png" alt="Windows key bindings uses a file called keyBindings.json" />
