...
<Image
  src="/src/assets/2019/focus/chrome-focus.png"
  alt="Default focus ring in Chrome."
/>
It is also great because **you don't have to write any code** to create a usable
focus ring.
...
<Image
  src="/src/assets/2019/focus/default-style.png"
  alt="Default focus style across browsers."
/>
Here's the second major problem. The default focus lacks contrast in specific
situations.
...
<Image
  src="/src/assets/2019/focus/default-style-dark.png"
  alt="Default focus style on a dark background."
/>
**Safari and Chrome's blue outlines lack contrast on pages with dark
backgrounds**. The contrast is even worse if you used a bluebackground.

<Image
  src="/src/assets/2019/focus/default-style-blue.png"
  alt="Default focus styles on a blue background. "
/>
...
<Image
  src="/src/assets/2019/focus/css-tricks-links.gif"
  alt="Tabbing over CSS Tricks links."
/>
However, buttons don't get any special treatment. If you focus over buttons, you
only see the default focus style. Also, the focus ring doesn't show up clearly
on the dark background.

<Image
  src="/src/assets/2019/focus/css-tricks-buttons.gif"
  alt="Tabbing over CSS Tricks buttons."
/>
There was a special treatment on tags though. When I focused on the tag for the
article, the white border popped out at me. I see this element clearly compared
to the others.

<Image
  src="/src/assets/2019/focus/css-tricks-header.gif"
  alt="Tabbing over CSS Tricks elements in the header."
/>
### Smashing Magazine
...
<Image
  src="/src/assets/2019/focus/smashing-text.gif"
  alt="Tabbing over links in Smashing Mag."
/>
However, the dark-red outline doesn't make focused elements stand out as much
when they're on a red background. The contrast wasn't huge. But the text color
change from white to black draws my attention.

<Image
  src="/src/assets/2019/focus/smashing-links.gif"
  alt="Tabbing over links in the red background on Smashing Mag."
/>
The dark-red outline failed to catch my attention when I tabbed through a button
on a red background. The `color` change from blue to red wasn't enough to draw
my attention.
...
<Image
  src="/src/assets/2019/focus/smashing-button.gif"
  alt="Tabbing over buttons in the red background on Smashing Mag."
/>
### Twitter
...
<Image
  src="/src/assets/2019/focus/twitter.gif"
  alt="Tabbing through a Twitter card."
/>
Here's what I think.
...
<Image
  src="/src/assets/2019/focus/twitter-sidebar.gif"
  alt="Tabbing through the sidebar on Twitter."
/>
### Slack
...
<Image
  src="/src/assets/2019/focus/slack.gif"
  alt="Tabbing through a Slack message."
/>
Slack used the same styles on the sidebar, but they used white instead. This
stuff works for both dark and light backgrounds!

<Image
  src="/src/assets/2019/focus/slack-sidebar.gif"
  alt="Tabbing through the sidebar in Slack."
/>
### WTF Forms
...
<Image
  src="/src/assets/2019/focus/wtf-forms.gif"
  alt="Tabbing through elements on WTF Forms."
/>
### My own site
...
<Image
  src="/src/assets/2019/focus/zellwk.gif"
  alt="Tabbing through links on my site."
/>
However, I did good work for the navigation. The pink border and animation made
the focused element pop. 🎉.

<Image
  src="/src/assets/2019/focus/zell-nav.gif"
  alt="Tabbing through my nav."
/>
## What I learned
