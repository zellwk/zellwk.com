...
description: Make interactive components: Events, event listeners, callbacks. Respond to user interaction with JavaScript.
...
<Youtube id='dTyVuBk5eIg' title='How to make interactive components' />
