...
pubDate: 2022-03-18
description: Deploy with rsync on custom SSH ports in GitHub Actions. Add ports as secrets, configure known_hosts, and set up the -e flag for automated deployments.
---
