...
<Image src="/images/2019/states/hover.gif" alt="On hover, button darkens slightly." />
...
<Image src="/images/2019/states/focus.gif" alt="Focus a button with Tab. When focused, shows an outline with box-shadow." />
...
<Image src="/images/2019/states/active.gif" alt="Changes background-color and color when user holds their left mouse button down on the button." />
...
<Image src="/images/2019/states/link-active.gif" alt="By default, links turn red when they get clicked." />
...
<Image src="/images/2019/states/magic-mouse-safari.gif" caption="Button's behavior on Safari after adding the JavaScript snippet above." />
...
<Image src="/images/2019/states/magic-mouse.gif" alt="Mouse users receive feedback on hover and on click." />
For keyboard users: 
...
<Image src="/images/2019/states/magic-keyboard.gif" alt="Keyboard users receive focus on Tab and on interaction." />
Best of both worlds! 
...
<Image src="/images/2019/states/magic-mouse-safari.gif" alt="Button behavior on click in Safari." />
...
<Image src="/images/2019/states/non-magic-safari.gif" caption="Button behavior on Safari if you styled all three states." />
