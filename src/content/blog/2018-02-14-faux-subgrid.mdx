---
title: Faux Subgrid
description: 'Faux subgrid CSS technique: Simulate CSS Grid subgrid behavior for nested layouts. Works with modern browsers while awaiting real subgrid.'
tags: [css]
pubDate: 2018-02-14
---
...
<Image
  src="/src/assets/2018/faux-subgrid/kats.png"
  alt="Image that contains 6 cats lined up in a grid"
/>
...
<Image
  src="/src/assets/2018/faux-subgrid/learnjavascript.png"
  alt="A component from learnjavascript.today that requires a nested HTML structure"
/>
...
<div class="component">
  ...
  <div class="grid">
    ...
    <ol class="list-of-components-1">
      <!-- ... -->
    </ol>
    <ol class="list-of-components-2">
      <!-- ... -->
    </ol>
...
<Codepen
  link="https://codepen.io/zellwk/pen/mXryjP"
  title="Faux subgrid example"
/>
...
<Codepen
  link="https://codepen.io/zellwk/pen/QQKbLr"
  title="Faux subgrid mixin"
/>
...
<Codepen
  link="https://codepen.io/zellwk/pen/qxadZO"
  title="Faux subgrid mixin (positioning subgrids with finesse)"
/>
