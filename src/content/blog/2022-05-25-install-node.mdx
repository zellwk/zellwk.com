...
tags: [node]
pubDate: 2022-05-25
description: Master Node.js installation and version management. Switch between Node versions easily with the `n` package manager for flexible development.
---

The easiest way to install Node is head over to [NodeJS's website](https://nodejs.org/en/) and download the LTS version.

<Image src="/src/assets/blog/node/lts.png" alt="" loading="lazy" />
...
<Image src="/src/assets/blog/node/versions.png" alt="" loading="lazy" />
...
<Callout>
  Node's version numbers are written with a standard called Semver. You can find
  out more about Semver [in this
  article](https://zellwk.com/blog/semantic-versioning/)
</Callout>
