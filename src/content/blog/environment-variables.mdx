...
<Image src="/assets/2019/dotenv/env-var.png" alt="Echoing the environment variable." />
...
<Image src="/assets/2019/dotenv/env-in-node.png" alt="Terminal shows Hello world! when we run the server.js file." />
...
<Image src="/assets/2019/dotenv/dotenv-location.png" alt="Placed the variables.env file in the secrets folder." />
...
<Image src="/assets/2019/dotenv/dotenv-usage.png" alt="Logged helloworld environment variable in the console." />
