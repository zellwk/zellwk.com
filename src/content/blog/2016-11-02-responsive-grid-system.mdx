...
description: Build responsive grids: Eight steps from design to code. Flexbox, floats, gutters, and breakpoints.
ckForm: css
tags: [css]
pubDate: 2016-11-02
---
...
<Image
  src="/src/assets/2016/building-grid-systems/box-sizing.jpg"
  alt="Box sizing property and how it affects width calculations"
  caption="Box sizing property and how it affects width calculations"
/>
...
<Image
  src="/src/assets/2016/building-grid-systems/columns.png"
  alt="Three-column grid without gutters"
  caption="Three-column grid without gutters"
/>
...
<Image
  src="/src/assets/2016/building-grid-systems/grid-break.gif"
  alt="Grid breaks below 1140px"
  caption="Grid breaks below 1140px"
/>
...
<Image
  src="/src/assets/2016/building-grid-systems/grid-columns.gif"
  alt="Three columns without gutters"
  caption="Three columns without gutters"
/>
...
<Image
  src="/src/assets/2016/building-grid-systems/float-collapse.png"
  alt="Float collapse. Image from CSS Tricks"
  caption="Float collapse (image from CSS Tricks)"
/>
...
<Image
  src="/src/assets/2016/building-grid-systems/combi.png"
  alt="4 possible ways to create columns and gutters"
  caption="4 possible ways to create columns and gutters"
/>
...
<Image
  src="/src/assets/2016/building-grid-systems/pattern-1side-margin.png"
  alt="One-sided gutters using margins"
  caption="One-sided gutters using margins"
/>
...
<Image
  src="/src/assets/2016/building-grid-systems/subpixel.png"
  alt="Subpixel rounding errors might break the grid by pushing the final item to the next row"
  caption="Subpixel rounding errors might break the grid by pushing the final item to the next row"
/>
...
<Image
  src="/src/assets/2016/building-grid-systems/margin-side-last-child.png"
  alt="Our code fails if there's more than one row"
  caption="Our code fails if there's more than one row"
/>
...
<Codepen
  link="https://codepen.io/zellwk/pen/mAYqrL"
  title="Single sided grid with gutters as margins"
/>
...
<Image
  src="/src/assets/2016/building-grid-systems/pattern-1side-gutter.png"
  alt="One-sided gutters using padding"
  caption="One-sided gutters using padding"
/>
...
<Image
  src="/src/assets/2016/building-grid-systems/pattern-split-margin.png"
  alt="Split gutters with margin"
  caption="Split gutters with margin"
/>
...
<Codepen
  link="https://codepen.io/zellwk/pen/BLZJza"
  title="Grid with split gutters as margins"
/>
...
<Image
  src="/src/assets/2016/building-grid-systems/pattern-split-padding.png"
  alt="Split gutters with padding"
  caption="Split gutters with padding"
/>
...
<Codepen
  link="https://codepen.io/zellwk/pen/ORYzQV"
  title="Grid with split gutters as padding"
/>
...
<Image
  src="/src/assets/2016/building-grid-systems/bg-relationship.jpg"
  alt="Background is shown on the padding property"
  caption="Background is shown on the padding property"
/>
...
<Codepen
  link="https://codepen.io/zellwk/pen/ALkyAA"
  title="Fixed gutter debug grid"
/>
...
<Image
  src="/src/assets/2016/building-grid-systems/grid-example.png"
  alt="Example grid layout that's only used for guest articles"
  caption="Example grid layout that's only used for guest articles"
/>
...
<Codepen
  link="https://codepen.io/zellwk/pen/pEmLzY"
  title="Content-sidebar-layout with fixed-gutter grid"
/>
...
<Image
  src="/src/assets/2016/building-grid-systems/grid-responsive.png"
  alt="How guest the guest article layout respond to different viewports"
  caption="How guest the guest article layout respond to different viewports"
/>
...
<Codepen
  link="https://codepen.io/zellwk/pen/qaGvxm"
  title="guest-article layout with fixed-gutter grid (final)"
/>
