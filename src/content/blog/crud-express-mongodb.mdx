...
<Image src='/assets/2020/crud/crud-express-mongo.png' alt='' />
...
<Image
  src='/assets/2020/crud/looks.png'
...
<Image src='/assets/2020/crud/node-version.png' alt='Node version' />
...
<Image src='/assets/2020/crud/npm-init.png' alt='npm init.' />
...
<Image
  src='/assets/2020/crud/node-log.png'
...
<Callout>
  What you install using npm will be added as a `dependency` in `package.json`. It's
  important to know these dependencies because `npm` can retrieve dependencies
  with another `npm install` command when you need it later.
</Callout>
...
<Image
  src='/assets/2020/crud/exp-dependency.png'
...
<Image src='/assets/2020/crud/cannot-get.png' alt='Cannot get /.' />
...
<Image src='/assets/2020/crud/get-hello-world.png' alt='' />
...
<Image src='/assets/2020/crud/get-index.png' alt='The HTML file.' />
...
<Image
  src='/assets/2020/crud/nodemon-dev-dep.png'
...
<Image
  src='/assets/2020/crud/nodemon-server.png'
  alt='Uses npm run dev to run nodemon server.js'
/>

<Callout>
  Node v18.11 added support for watch mode. This watches for changes and restarts the server so you don't have to use Nodemon. You can simply run `node --watch server.js` instead.
</Callout>
...
<Image
  src='/assets/2020/crud/post-log.png'
...
<Image
  src='/assets/2020/crud/post-log-req-body.png'
...
<Image
  src='/assets/2020/crud/atlas-create-org.png'
...
<Image
  src='/assets/2020/crud/atlas-select-cloud.png'
...
<Image src='/assets/2020/crud/atlas-projects.png' alt='Atlas project screen.' />
...
<Image src='/assets/2020/crud/atlas-cp.png' alt='Creating a new project.' />

Next, you will need to name your project. Call it anything you want. I'm going to call this `star-wars`.

<Image
  src='/assets/2020/crud/atlas-cp-name-project.png'
...
<Image src='/assets/2020/crud/atlas-cluster.png' alt='Create Cluster Screen.' />

Click on "Build a Cluster". You should see this screen:

<Image src='/assets/2020/crud/atlas-cc.png' alt='Selecting a cluster' />
...
<Image src='/assets/2020/crud/atlas-cc-m0.png' alt='Configured the cluster.' />

Click on Create cluster next. You should see "Your cluster is being created".

<Image src='/assets/2020/crud/atlas-cc-creating.png' alt='Creating cluster.' />

You have to wait for approximately 5 minutes for the cluster creation. When the cluster is ready, you'll see this:

<Image src='/assets/2020/crud/atlas-cc-ready.png' alt='Cluster ready' />
...
<Image src='/assets/2020/crud/atlas-connect.png' alt='Connect button.' />

A modal should pop up.

<Image
  src='/assets/2020/crud/atlas-connect-modal.png'
...
<Image
  src='/assets/2020/crud/atlas-connect-add-ip.png'
  alt='Adds IP address.'
/>
...
<Image
  src='/assets/2020/crud/atlas-connect-mongodb-user.png'
  alt='MongoDB User.'
/>
...
<Image
  src='/assets/2020/crud/atlas-connect-method.png'
  alt='Choosing a connection method.'
/>

<Image
  src='/assets/2020/crud/atlas-connection-string.png'
...
<Image
  src='/assets/2020/crud/connect-no-deprecation-warnings.png'
...
<Image src='/assets/2020/crud/post-result.png' alt='Post result.' />
...
<Image
  src='/assets/2020/crud/atlas-collections.png'
...
<Image
  src='/assets/2020/crud/atlas-collection-view.png'
...
<Image
  src='/assets/2020/crud/post-loading.png'
...
<Image
  src='/assets/2020/crud/post-redirected.png'
...
<Image src='/assets/2020/crud/cursor.png' alt='Cursor object from MongoDB' />
...
<Image src='/assets/2020/crud/mongodb-get.png' alt='' />
...
<Image src='/assets/2020/crud/get-ejs.png' alt='Renders an ejs file.' />
...
<Image src='/assets/2020/crud/ejs-quotes.png' alt='Rendered quotes in EJS.' />
...
<Image
  src='/assets/2020/crud/ejs-rendered-quotes.png'
...
<Image src='/assets/2020/crud/put-ejs.png' alt='Add update section to HTML.' />
...
<Image src='/assets/2020/crud/put-body.png' alt='Put request body' />
...
<Image src='/assets/2020/crud/put-result.png' alt='Put result.' />

If you refresh the browser, you should see Darth Vader's quote as the first quote.

<Image
  src='/assets/2020/crud/put-check.png'
...
<Image
  src='/assets/2020/crud/put-response.png'
...
<Image
  src='/assets/2020/crud/delete-ejs.png'
...
<Image
  src='/assets/2020/crud/delete-result.gif'
