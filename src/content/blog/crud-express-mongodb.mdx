...
tags: [best, node, mongodb, express, javascript]
ckForm: crud
pubDate: 2020-04-09
---
...
<Image src='/images/2020/crud/crud-express-mongo.png' alt='' />
...
<Image
  src='/images/2020/crud/looks.png'
...
<Image src='/images/2020/crud/node-version.png' alt='Node version' />
...
<Image src='/images/2020/crud/npm-init.png' alt='npm init.' />
...
<Image
  src='/images/2020/crud/node-log.png'
...
<Image
  src='/images/2020/crud/exp-dependency.png'
...
<Image src='/images/2020/crud/cannot-get.png' alt='Cannot get /.' />
...
<Image src='/images/2020/crud/get-hello-world.png' alt='' />
...
<Image src='/images/2020/crud/get-index.png' alt='The HTML file.' />
...
<Image
  src='/images/2020/crud/nodemon-dev-dep.png'
...
<Image
  src='/images/2020/crud/nodemon-server.png'
...
<Image
  src='/images/2020/crud/post-log.png'
...
<Image
  src='/images/2020/crud/post-log-req-body.png'
...
<Image
  src='/images/2020/crud/atlas-create-org.png'
...
<Image
  src='/images/2020/crud/atlas-select-cloud.png'
...
<Image src='/images/2020/crud/atlas-projects.png' alt='Atlas project screen.' />
...
<Image src='/images/2020/crud/atlas-cp.png' alt='Creating a new project.' />

Next, you will need to name your project. Call it anything you want. I'm going to call this `star-wars`.

<Image
  src='/images/2020/crud/atlas-cp-name-project.png'
...
<Image src='/images/2020/crud/atlas-cluster.png' alt='Create Cluster Screen.' />

Click on "Build a Cluster". You should see this screen:

<Image src='/images/2020/crud/atlas-cc.png' alt='Selecting a cluster' />
...
<Image src='/images/2020/crud/atlas-cc-m0.png' alt='Configured the cluster.' />

Click on Create cluster next. You should see "Your cluster is being created".

<Image src='/images/2020/crud/atlas-cc-creating.png' alt='Creating cluster.' />

You have to wait for approximately 5 minutes for the cluster creation. When the cluster is ready, you'll see this:

<Image src='/images/2020/crud/atlas-cc-ready.png' alt='Cluster ready' />
...
<Image src='/images/2020/crud/atlas-connect.png' alt='Connect button.' />

A modal should pop up.

<Image
  src='/images/2020/crud/atlas-connect-modal.png'
...
<Image
  src='/images/2020/crud/atlas-connect-add-ip.png'
  alt='Adds IP address.'
/>
...
<Image
  src='/images/2020/crud/atlas-connect-mongodb-user.png'
  alt='MongoDB User.'
/>
...
<Image
  src='/images/2020/crud/atlas-connect-method.png'
  alt='Choosing a connection method.'
/>

<Image
  src='/images/2020/crud/atlas-connection-string.png'
...
<Image src='/images/2020/crud/connected.png' alt='Connected to database.' />
...
<Image
  src='/images/2020/crud/connect-no-deprecation-warnings.png'
...
<Image src='/images/2020/crud/post-result.png' alt='Post result.' />
...
<Image
  src='/images/2020/crud/atlas-collections.png'
...
<Image
  src='/images/2020/crud/atlas-collection-view.png'
...
<Image
  src='/images/2020/crud/post-loading.png'
...
<Image
  src='/images/2020/crud/post-redirected.png'
...
<Image src='/images/2020/crud/cursor.png' alt='Cursor object from MongoDB' />
...
<Image src='/images/2020/crud/mongodb-get.png' alt='' />
...
<Image src='/images/2020/crud/get-ejs.png' alt='Renders an ejs file.' />
...
<Image src='/images/2020/crud/ejs-quotes.png' alt='Rendered quotes in EJS.' />
...
<Image
  src='/images/2020/crud/ejs-rendered-quotes.png'
...
<Image src='/images/2020/crud/put-ejs.png' alt='Add update section to HTML.' />
...
<Image src='/images/2020/crud/put-body.png' alt='Put request body' />
...
<Image src='/images/2020/crud/put-result.png' alt='Put result.' />

If you refresh the browser, you should see Darth Vader's quote as the first quote.

<Image
  src='/images/2020/crud/put-check.png'
...
<Image
  src='/images/2020/crud/put-response.png'
...
<Image
  src='/images/2020/crud/delete-ejs.png'
...
<Image
  src='/images/2020/crud/delete-result.gif'
