...
Many developers feel they _need_ to write clean code. They're good developers only if they write clean code. They're lousy developers if they don't.
...
We get stuck because we focus on _trying_ to write clean code. Our ideas don't flow.
