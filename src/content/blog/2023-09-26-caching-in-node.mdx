...
It's easy to do this with the [`getLastModifiedTime`](https://splendid-ui.com/node/get-last-modified-time) utility from Splendid UI.
...
- [fileCache](https://splendid-ui.com/node/file-cache/)
- [getLatestModifiedTime](https://splendid-ui.com/node/get-last-modified-time/)
