...
description: JavaScript semicolons optional or required: Use a linter for consistent code style.
...
<Youtube id='TODFjRDfosk' title='Should you use semicolons in JavaScript?' />
