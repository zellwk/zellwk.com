...
<Image
  src='https://res.cloudinary.com/indysigner/image/upload/v1525708189/which-one-of-the-two-possible-websites-are-you-currently-designing_hxjfnc.png'
  alt='A tweet by Jon Gold asking: “which one of the two possible websites are you currently designing?”'
  caption='On Twitter, Jon Gold is asking: “which one of the two possible websites are you currently designing?”'
/>
