...
description: 'Fluid responsive typography with viewport units: Scale fonts without media queries. Master vw precision formulas, browser support.'
tags: [typography, css]
ckForm: mwt
pubDate: 2016-03-09
---
...
<Image
  src="/src/assets/2016/viewport-based-typography/viewport-units.png"
  alt="Viewport units"
  caption="100vw and 100vh"
/>
...
<Image
  src="/src/assets/2016/viewport-based-typography/quarter-viewport-component.gif"
  alt="Quarter viewport component"
  caption="A component that's always a quarter of the viewport"
/>
...
<Image
  src="/src/assets/2016/viewport-based-typography/font-size-in-vw.gif"
  alt="Font size in vw"
  caption="Resizing text automatically with viewport units!"
/>
...
<Image
  src="/src/assets/2016/viewport-based-typography/font-size-vw-tamed.gif"
  alt="Font size tamed"
  caption="Font sized with vw now tamed!"
/>
...
<Image
  src="/src/assets/2016/viewport-based-typography/viewport-sized-header.png"
  alt="Incorrectly sized h1"
  caption="H1 has sized incorrectly :("
/>
...
<Image
  src="/src/assets/2016/viewport-based-typography/correctly-sized-header.png"
  alt="Correctly sized headers"
  caption="H1 now correctly sized with em!"
/>
