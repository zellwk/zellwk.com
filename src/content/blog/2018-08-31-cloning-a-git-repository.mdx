...
Let's say we want to clone [Typi](https://github.com/zellwk/typi). Typi is a library I made to make Typography easy for you when you're creating websites.

To clone the project, you click on the big green button that says clone or download.

<Image src="/src/assets/2018/git-clone/clone.png" alt="The clone button" />
...
<Image src="/src/assets/2018/git-clone/git-url.png" alt="The git URL" />
...
<Image
  src="/src/assets/2018/git-clone/fork-clone.png"
...
<Image src="/src/assets/2018/git-clone/cloned.png" caption="Project cloned" />
...
<Image
  src="/src/assets/2018/git-clone/switch.png"
...
<Image
  src="/src/assets/2018/git-clone/collaborator.png"
