...
This code can be really complicated to remember. So I abstracted it into a `dirname` function in [Splendid UI](https://splendid-ui.com).
...
- [`dirname` utility documentation](https://splendid-ui.com/node/dirname)
