...
description: Skip the bundler and use npm packages directly in the frontend with ES modules. Import from CDNs or serve node_modules for simpler JavaScript projects.
---
