...
<Image src='/images/2022/node-https-localhost/generate-certs.png' alt='' />

I like to put these files in a `certs` folder and rename them into `key.pem` and `cert.pem` to keep things tidy.

<Image src='/images/2022/node-https-localhost/rename-certs.png' alt='' />
...
<Image src='/images/2022/node-https-localhost/demo.png' alt='' />
