...
description: 'Set up JavaScript development environment: Syntax highlighting, linters, and snippets for better code.'
tags: [javascript]
...
<Callout type="note">
  This is an old article so some of these recommendations are no longer valid.
  Please see [this
  article](/blog/beginner-and-intermediate-web-development-setup-2022/) for my
...
<Image
  src="/src/assets/2017/jsenv/no-highlight.png"
  alt="Code that's not highlighted"
  caption="Code that's not highlighted"
/>

Compare this version with one that's highlighted:

<Image
  src="/src/assets/2017/jsenv/highlight.png"
  alt="Highlighted code is easier to read"
  caption="Highlighted code is easier to read"
/>
...
For example, I know at a glance that `const` is a keyword since it's _purple_ in color, `sayText` is a function since it's _blue_ in color, and `Hello world` is a string since it's _green_ in color.
...
For instance, [Wes Bos](http://wesbos.com), a developer I actively follow and respect, uses _Cobalt_. On the other hand, I'll go bonkers if I used _Cobalt_. So far, the best theme I found for myself is _Tomorrow night eighties_. That's what I used for my code editor (Sublime Text) and the code snippets on this blog.
...
<iframe
  src="https://player.vimeo.com/video/219461142"
  width="640"
  height="400"
  frameborder="0"
...
<Image
  src="/src/assets/2017/jsenv/lint.png"
  alt="The linter shows something is wrong with my code"
  caption="The linter shows something is wrong with my code"
/>
...
<Image
  src="/src/assets/2017/jsenv/lint-format.png"
  alt="Linters can point out formatting errors in your code"
  caption="Linters can point out formatting errors in your code"
/>
...
<Image
  src="/src/assets/2017/jsenv/lint-hover.png"
  alt="You can hover on linted areas to see what's wrong"
  caption="You can hover on linted areas to see what's wrong"
/>
...
<Image
  src="/src/assets/2017/jsenv/lint-formatting.gif"
  alt="Autoformatting syntax issues with Standard Format"
  caption="Autoformatting syntax issues with Standard Format"
/>
...
<Image
  src="/src/assets/2017/jsenv/snippets.png"
  alt="Snippets can help recall methods and also write faster"
  caption="Snippets can help recall methods and also write faster"
/>
