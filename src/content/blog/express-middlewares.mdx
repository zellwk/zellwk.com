...
<Image src="/images/2019/express-middlewares/200.png" alt="Example of a Dev log." />
...
<Image src="/images/2019/express-middlewares/breakdown.png" alt="Identifies the method and endpoint in a dev log." />
...
<Image src="/images/2019/express-middlewares/200.png" alt="200 status code is green." />
A 300+ status code is cyan:

<Image src="/images/2019/express-middlewares/300.png" alt="300 status code is cyan." />
A 400+ status code is yellow:

<Image src="/images/2019/express-middlewares/400.png" alt="400 status code is yellow." />
And a 500+ status code is red:

<Image src="/images/2019/express-middlewares/500.png" alt="500 status code is red." />
## CamelCase
