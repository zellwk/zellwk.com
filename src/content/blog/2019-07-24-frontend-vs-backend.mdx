...
1. Are videos/assets/gifs too large?
...
<Image
  src="/src/assets/2019/frontend-vs-backend/server.png"
  alt="Image of a frontend, a server, and a database."
/>
...
<Image
  src="/src/assets/2019/frontend-vs-backend/bell-telephone-operators.jpg"
  caption="Watch [bell telephone switchboard operators](https://youtu.be/2BzRjfOoiVQ) at work"
/>
