...
description: Build calculator edge cases in JavaScript. Handle decimal keys, operator chains, equal key quirks. Code for user mistakes.
tags: [javascript]
ckForm: calculator
pubDate: 2018-03-28
---
...
<Image
  src="/src/assets/2018/calculator-2/decimal-multiple.gif"
  alt="Nothing happens when a user hits the decimal key when the display already shows a decimal point"
  caption="Nothing happens when a user hits the decimal key when the display already shows a decimal point"
/>

<Image
  src="/src/assets/2018/calculator-2/decimal-multiple-2.gif"
  alt="Nothing should happen even if the previous key isn't the decimal key"
  caption="Nothing should happen even if the previous key isn't the decimal key"
/>
...
<Image
  src="/src/assets/2018/calculator-2/decimal-after-operator.gif"
  alt="Display should show '0.' if a user hits a decimal key after an operator key"
  caption="Display should show `0.` if a user hits a decimal key after an operator key"
/>
...
<Image
  src="/src/assets/2018/calculator-2/operator-first.gif"
  alt="Operator key should light up if it's the first key."
  caption="Operator key should light up if it's the first key."
/>
...
<Image
  src="/src/assets/2018/calculator-2/operator-multiple.gif"
  alt="Operator key remains depressed if clicked on multiple times"
  caption="Operator key remains depressed if clicked on multiple times"
/>
...
<Image
  src="/src/assets/2018/calculator-2/operator-switch.gif"
  alt="The new operator key should be depressed"
  caption="The new operator key should be depressed"
/>
...
<Image
  src="/src/assets/2018/calculator-2/operator-calc.gif"
  alt="Clicking on the operator when numbers are stored in the calculator results in a calculation"
  caption="Clicking on the operator when numbers are stored in the calculator results in a calculation"
/>
...
<Image
  src="/src/assets/2018/calculator-2/bug-operator-immed-calc.gif"
  alt="Bug: subsequent clicks on the operator performs a calculation when it shouldn't"
  caption="Bug: subsequent clicks on the operator performs a calculation when it shouldn't"
/>
...
<Image
  src="/src/assets/2018/calculator-2/operator-consec-calc.gif"
  alt="Calculator should be able to continue calculation when a user clicks on numbers, followed by operators, followed by numbers, followed by operators, and so on."
  caption="Calculator should be able to continue calculation when a user clicks on numbers, followed by operators, followed by numbers, followed by operators, and so on."
/>
...
<Image
  src="/src/assets/2018/calculator-2/operator-consec-calc-bug.gif"
  alt="Calculated values are wrong. Second calculated value should be 97 instead of 0"
  caption="Calculated values are wrong. Second calculated value should be 97 instead of 0"
/>
...
<Image
  src="/src/assets/2018/calculator-2/op-consec-calc-1.png"
  alt="When a user hits numbers, the calculator doesn't register `firstValue` or `operator`"
  caption="When a user hits numbers, the calculator doesn't register `firstValue` or `operator`"
/>
...
<Image
  src="/src/assets/2018/calculator-2/op-consec-calc-2.png"
  alt="`firstValue` and `operator` are set after the operator button is clicked"
  caption="`firstValue` and `operator` are set after the operator button is clicked"
/>
...
<Image
  src="/src/assets/2018/calculator-2/op-consec-calc-3.png"
  alt="Display updates to 1, but `firstValue` and `operator` remains at `99` and `subtract`"
  caption="Display updates to 1, but `firstValue` and `operator` remains at `99` and `subtract`"
/>
...
<Image
  src="/src/assets/2018/calculator-2/op-consec-calc-4.png"
  alt="We set `secondValue` to 1"
  caption="We set `secondValue` to 1"
/>
...
<Image
  src="/src/assets/2018/calculator-2/op-consec-calc-5.png"
  alt="After calculation, firstValue is set to `displayedNum`"
  caption="After calculation, firstValue is set to `displayedNum`"
/>
...
<Image
  src="/src/assets/2018/calculator-2/op-consec-calc-6.png"
  alt="updates calculated value as `firstValue`"
  caption="updates calculated value as `firstValue`"
/>
...
<Image
  src="/src/assets/2018/calculator-2/op-consec-calc-fixed.gif"
  alt="Consecutive calculations done with the operator key is now correct"
  caption="Consecutive calculations done with the operator key is now correct"
/>
...
<Image
  src="/src/assets/2018/calculator-2/equal-first.gif"
  alt="Calculator should show zero if equal key is hit first"
  caption="Calculator should show zero if equal key is hit first"
/>

<Image
  src="/src/assets/2018/calculator-2/equal-after-num.gif"
  alt="When no calculation is required, display remains the same"
  caption="When no calculation is required, display remains the same"
/>
...
<Image
  src="/src/assets/2018/calculator-2/num-op-equal.gif"
  alt="The calculator should treat first and second values as the same numbers if it's missing a value"
  caption="The calculator should treat first and second values as the same numbers if it's missing a value"
/>
...
<Image
  src="/src/assets/2018/calculator-2/eq-consec-click-fixed.gif"
  alt="When a user hits the equal key multiple times, the calculator should continue to calculate"
  caption="When a user hits the equal key multiple times, the calculator should continue to calculate"
/>
...
<Image
  src="/src/assets/2018/calculator-2/eq-consec-calc-wrong.gif"
  alt="Equal key consecutive calculation gives a wrong result"
  caption="Equal key consecutive calculation gives a wrong result"
/>
...
<Image
  src="/src/assets/2018/calculator-2/eq-consec-calc-1.png"
  alt="When a user clicked on the first number the calculator doesn't register `firstValue` or `operator`"
  caption="When a user clicked on the first number the calculator doesn't register `firstValue` or `operator`"
/>
...
<Image
  src="/src/assets/2018/calculator-2/eq-consec-calc-2.png"
  alt="`firstValue` and `operator` are set after the operator button is clicked"
  caption="`firstValue` and `operator` are set after the operator button is clicked"
/>
...
<Image
  src="/src/assets/2018/calculator-2/eq-consec-calc-3.png"
  alt="Display updates to 1, but `firstValue` and `operator` remains at `5` and `subtract`"
  caption="Display updates to 1, but `firstValue` and `operator` remains at `5` and `subtract`"
/>
...
<Image
  src="/src/assets/2018/calculator-2/eq-consec-calc-4.png"
  alt="`displayedNum` is set as `secondValue`"
  caption="We set `secondValue` as `displayedNum` "
/>
...
<Image
  src="/src/assets/2018/calculator-2/eq-consec-calc-5.png"
  alt="`firstValue` and `operator` are used for the next operation"
  caption="`firstValue` and `operator` are used for the next operation"
/>

Sixth, when the user hits equal again, we set `secondValue` to `displayedNum` before the calculation.

<Image
  src="/src/assets/2018/calculator-2/eq-consec-calc-6.png"
  alt="Once again, displayed num is set as the `secondValue` before the calculation"
  caption="Once again, displayed num is set as the `secondValue` before the calculation"
/>
...
<Image
  src="/src/assets/2018/calculator-2/eq-consec-click-fixed.gif"
  alt="Consecutive calculations made by the equal key is now fixed"
  caption="Consecutive calculations made by the equal key is now fixed"
/>
...
<Image
  src="/src/assets/2018/calculator-2/op-after-eq.gif"
  alt="Operator keys should not perform calculations if they're clicked after the equal key"
  caption="Operator keys should not perform calculations if they're clicked after the equal key"
/>
...
<Image
  src="/src/assets/2018/calculator-2/default.png"
  alt="AC should be shown in the initial state"
  caption="AC should be shown in the initial state"
/>

First, if Tim hits a key (any key except clear), `AC` should be changed to `CE`.

<Image
  src="/src/assets/2018/calculator-2/decimal-first.gif"
  alt="AC changes to CE when a key (except clear) gets hit"
  caption="AC changes to CE when a key (except clear) gets hit"
/>
...
<Image
  src="/src/assets/2018/calculator-2/clear.gif"
  alt="If CE is clicked, AC should show"
  caption="If CE is clicked, AC should show"
/>
