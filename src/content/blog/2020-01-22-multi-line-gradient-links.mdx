...
<Image
  src='/images/2020/multi-line-gradient/link.gif'
...
<Image
  src='/images/2020/multi-line-gradient/gradient-text.png'
...
<Image
  src='/images/2020/multi-line-gradient/gradient-text-2.png'
...
<Image
  src='/images/2020/multi-line-gradient/multiline-safari.png'
...
<Image
  src='/images/2020/multi-line-gradient/multiline-safari-fixed.png'
...
<Image
  src='/images/2020/multi-line-gradient/text-fill-color.gif'
...
<Image
  src='/images/2020/multi-line-gradient/text-decoration-color.png'
...
/>
I suggest you don't add `text-decoration` underlines to large text. Consider [creating
underlines with a different method ][4]instead.{' '}

## Gradient + Focus

Gradient links look amazing with focus outlines. [Just saying][5].

<Image src='/images/2020/multi-line-gradient/focus.gif' alt='' />
