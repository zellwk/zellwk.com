...
description: New zlFetch features — returnError for cleaner async error handling, a debug mode to inspect requests, and reusable instances with createZlFetch.
