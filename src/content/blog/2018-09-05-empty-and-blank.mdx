...
<Image
  src='/images/2018/empty-and-blank/tweet.png'
...
<Image
  src='/images/2018/empty-and-blank/empty-browser-support.png'
  alt='Empty supported by every browser'
  caption=':empty browser support'
/>

<Image
  src='/images/2018/empty-and-blank/blank-browser-support.png'
  alt='Blank is not supported by any browser'
