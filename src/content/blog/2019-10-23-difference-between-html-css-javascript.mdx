...
description: HTML creates the structure of a website. CSS makes it look nice. JavaScript makes it interactive.
...
<p
  ...
  data-user="zellwk"
  data-slug-hash="vYBWLwM"
  style="height: 404px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;"
  data-pen-title="vYBWLwM"
>
  <span>
    See the Pen <a href="https://codepen.io/zellwk/pen/vYBWLwM/">vYBWLwM</a> by
...
<Image
  src="/src/assets/2019/html-css-js/off-canvas.gif"
  alt="Menu pops out when I click a button. Menu closes when I click the button again."
/>
