...
description: 'JavaScript functions explained: Declare, call, parameters, return. Build reusable code blocks.'
...
Once you declared your function, you can use (_or invoke, or call, or execute_) it by writing the name of the function, followed by parenthesis `()`.
...
<Image
  src="/src/assets/2017/js-functions/declare.png"
  alt="Declaring and using sayHello function"
  caption="Declaring and using sayHello function"
/>
...
<Image
  src="/src/assets/2017/js-functions/flow-1.png"
  alt="JavaScript sees add2 and skips it"
  caption="JavaScript sees add2 and skips it"
/>
...
<Image
  src="/src/assets/2017/js-functions/flow-2.png"
  alt="JavaScript executes the add2 function"
  caption="JavaScript executes the add2 function"
/>
...
<Image
  src="/src/assets/2017/js-functions/flow-3.png"
  alt="JavaScript evaluates num + 2 as 10"
  caption="JavaScript evaluates num + 2 as 10"
/>
...
<Image
  src="/src/assets/2017/js-functions/flow-4.png"
  alt="JavaScript replaces add2(8) with the result, 10"
  caption="JavaScript replaces add2(8) with the result, 10"
/>
