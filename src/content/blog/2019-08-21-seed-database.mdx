...
<Image src="/src/assets/2019/seed-database/create.png" alt="Create runs the save middleware." />
If you use `insertMany`, you'll get users without hashed passwords: 

<Image src="/src/assets/2019/seed-database/insert-many.png" alt="InsertMany does not run the save middleware." />
