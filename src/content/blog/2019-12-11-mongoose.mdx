...
<Image
  src="/src/assets/2019/mongoose/connect-database.png"
...
<Image
  src="/src/assets/2019/mongoose/saved.png"
  alt="Ryu saved to the database."
/>
...
<Image
  src="/src/assets/2019/mongoose/three-ryus.png"
  alt="Three Ryus in the database."
/>
We don't want to have three Ryus in the database. We want to have **ONE Ryu
only**. To do this, we can use the **unique** option.
...
<Image
  src="/src/assets/2019/mongoose/dup-error.png"
  alt="Duplicated key error."
/>
...
<Image
  src="/src/assets/2019/mongoose/ryu-ken.png"
...
<Image
  src="/src/assets/2019/mongoose/found-one.png"
...
<Image
  src="/src/assets/2019/mongoose/found-many-ryu.png"
  alt="Combed through the database and found one character with the name Ryu."
/>
If you did not specify any properties to search for, it'll return an array that
contains all documents in the collection.
...
<Image
  src="/src/assets/2019/mongoose/found-many.png"
...
<Image src="/src/assets/2019/mongoose/ryu-updated.png" alt="Updated Ryu." />
### findOneAndUpdate
