...
description: zlFetch now handles FormData automatically, plus new toObject and toQueryString utilities that make working with form data much simpler.
...
<Image src="/src/assets/blog/zl-fetch-form-data/logging-form-data.png" />
...
<Image src="/src/assets/blog/zl-fetch-form-data/logging-to-object.png" />
...
I also added this utility into [Splendid UI](https://splendidlabz.com) 🙃. So you can tell that I’m putting lots of helpful things into Splendid UI as I go along.
...
- See how [Splendid UI](https://splendidlabz.com) makes web development much easier for you and me!
