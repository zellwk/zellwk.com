...
description: Responsive vertical rhythm with CSS custom properties and calc. Maintain typography consistency across viewports using variables.
tags: [css, typography]
...
<Image
  src="/src/assets/2018/responsive-vertical-rhythm/var-change.gif"
  alt="GIF that shows a paragraph to text switching between red and blue colors"
  caption="CSS Custom properties are updated dynamically, even within media queries!"
/>
...
<Image
  src="/src/assets/2018/responsive-vertical-rhythm/baseline-resize.gif"
  alt="GIF that shows that line-height can be changed via the baseline custom property."
  caption="Line height can be changed at different breakpoints via a custom property"
/>
...
<Image
  src="/src/assets/2018/responsive-vertical-rhythm/calc-resize.gif"
  alt="GIF that shows the margins of both <h2> and <p> change at the breakpoint"
  caption="CSS Calc can be used together with CSS Custom Properties to calculate rhythm values"
/>
...
<Image
  src="/src/assets/2018/responsive-vertical-rhythm/ciu-custom-props.png"
  alt="Support chart for CSS Custom properties from caniuse.com"
  caption="CSS Custom Properties are pretty well supported!"
/>

<Image
  src="/src/assets/2018/responsive-vertical-rhythm/ciu-calc.png"
  alt="Support chart for CSS Calc from caniuse.com"
  caption="CSS Calc is pretty well supported too!"
/>
