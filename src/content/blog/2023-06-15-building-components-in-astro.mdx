...
description: I used to build everything in .astro files. After months of real use, I switched most components to Svelte instead. Here's why — and when .astro still makes sense.
tags: [astro, svelte]
pubDate: 2023-06-15
ckForm: astro
---
