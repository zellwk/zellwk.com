...
description: Tailwind's space utilities break with Astro components because of display:contents wrappers. Here's a simple plugin that fixes it.
tags: [astro, splendidlabz, tailwind]
pubDate: 2023-10-10
---
...
- [Astro Space Utility](https://splendidlabz.com/tailwind/astro-space)
