...
<Image
  src="/src/assets/2020/ljs-portal-3/account-page.png"
  alt="The account page."
/>
...
<Image
  src="/src/assets/2020/ljs-portal-3/change-password-1.png"
  alt="Password fields in a single column."
/>
...
<Image
  src="/src/assets/2020/ljs-portal-3/change-password-2.png"
  alt="Labes on the left, fields on the right."
/>
...
<Image
  src="/src/assets/2020/ljs-portal-3/change-password-3.png"
  alt="Aligned labels to the right."
/>
...
<Image
  src="/src/assets/2020/ljs-portal-3/change-password-done.png"
  alt="Aligned buttons to the right."
/>
...
<Image
  src="/src/assets/2020/ljs-portal-3/components-table.png"
  alt="Example of a table of lessons for each component. It contains three columns: Lesson, starter files, source code. "
/>
