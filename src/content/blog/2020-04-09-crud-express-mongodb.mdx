...
<Image src="/images/2020/crud/looks.png" alt="Add CSS to make the app look better." />
...
<Image src="/images/2020/crud/node-log.png" alt="Logged May Node be with you."/>
...
<Image src="/images/2020/crud/exp-dependency.png" alt="Saved express as a dependency"/>
...
<Image src="/images/2020/crud/nodemon-dev-dep.png" alt="Saved Nodemon as a dev dependency." />
...
<Image src="/images/2020/crud/nodemon-server.png" alt="Uses npm run dev to run nodemon server.js" />
...
<Image src="/images/2020/crud/post-log.png" alt="Logs helloooo in the command line."/>
...
<Image src="/images/2020/crud/post-log-req-body.png" alt="Logs the request body."/>
...
<Image src="/images/2020/crud/atlas-create-org.png" alt="Creates an Atlas Organization" />

You also need to select a cloud service. Go ahead with MongoDB Atlas in this case.

<Image src="/images/2020/crud/atlas-select-cloud.png" alt="Selects a cloud service."/>
...
<Image src="/images/2020/crud/atlas-cp-name-project.png" alt="Naming the project." />
...
<Image src="/images/2020/crud/atlas-connect-modal.png" alt="Connection modal." />
...
<Image src="/images/2020/crud/atlas-connect-add-ip.png" alt="Adds IP address." />
...
<Image src="/images/2020/crud/atlas-connect-mongodb-user.png" alt="MongoDB User." />

Next, click on choose your connection method. Select "Connect to your application" and copy the connection string.

<Image src="/images/2020/crud/atlas-connect-method.png" alt="Choosing a connection method." />

<Image src="/images/2020/crud/atlas-connection-string.png" alt="Copy the connection string." />
...
<Image src="/images/2020/crud/connect-no-deprecation-warnings.png" alt="Connection without deprecation warning." />
...
<Image src="/images/2020/crud/atlas-collections.png" alt="Collections in MongoDB Atlas." />

You should see a document in your database. (Each database entry is called a document).

<Image src="/images/2020/crud/atlas-collection-view.png" alt="Documents in MongoDB Atlas." />

If you go back to the Browser, you'll see it's still trying to load something.

<Image src="/images/2020/crud/post-loading.png" alt="Browser still trying to load a page." />
...
<Image src="/images/2020/crud/post-redirected.png" alt="Redirected. Browser is no longer waiting to load something." />
...
<Image src="/images/2020/crud/ejs-rendered-quotes.png" alt="Rendered quotes with EJS." />
...
<Image src="/images/2020/crud/put-check.png" alt="Checking the HTML after a PUT request." />
...
<Image src="/images/2020/crud/put-response.png" alt="Response from the server." />
...
<Image src="/images/2020/crud/delete-ejs.png" alt="Adds delete button to the index.ejs file." />
...
<Image src="/images/2020/crud/delete-result.gif" alt="Message if no quotes can be deleted." />
