...
description: 'Migrate from Bootstrap to CSS grids: Four-step process. Use Susy and Flexbox. Cleaner code, better flexibility, no framework classes.'
tags: [css, susy]
ckForm: susy
pubDate: 2016-03-30
---
...
<Image
  src="/src/assets/2016/html-grids-to-css-grids/layout-content-sidebar.png"
  caption="Content Sidebar Layout pattern"
/>
...
<Image
  src="/src/assets/2016/html-grids-to-css-grids/layout-grid-3col.png"
  caption="3-column grid layout"
/>
...
<Image
  src="/src/assets/2016/html-grids-to-css-grids/layout-featured.png"
...
```scss
.l-cs {
  @include clearfix > div: nth-child(1) {
    @media (min-width: 600px) {
      @include span(9);
    }
  }
...
<Codepen
  height="105"
  link="https://codepen.io/zellwk/pen/ONjjJK"
  title="Content Sidebar Layout with Vanilla SCSS"
/>
...
<Codepen
  height="104"
  link="https://codepen.io/zellwk/pen/eZEEJR"
  title="3-column Grid Layout with Susy"
/>
...
_Note: I'm leaving out vendor prefixes to make the code simpler. Please use [autoprefixer](https://autoprefixer.github.io) to generate these vendor prefixes. It's the best method out there._
...
<Image
  src="/src/assets/2016/html-grids-to-css-grids/l-fg-req-space.png"
  caption="Flex items only take up their required spaces"
/>
...
<Image
  src="/src/assets/2016/html-grids-to-css-grids/l-fg-mobile.png"
  caption="Fixing Flexbox layout for mobile"
/>

_Note: I added a gray border of 1px here to help you see the boundary of each grid item._
...
<Image
  src="/src/assets/2016/html-grids-to-css-grids/l-fg-1.png"
  caption="Three-column featured grid without margins"
/>
...
<Image
  src="/src/assets/2016/html-grids-to-css-grids/l-fg-2.png"
  caption="Layout gets screwed up because Flex-basis wasn't calculated properly "
/>
...
<Image
  src="/src/assets/2016/html-grids-to-css-grids/l-fg-3.png"
  caption="three-column-grid with Flexbox"
/>
...
<Image
  src="/src/assets/2016/html-grids-to-css-grids/l-fg-4.png"
  caption="3-column Feature Grid with Flexbox"
/>
...
<Image
  src="/src/assets/2016/html-grids-to-css-grids/l-fg-5.png"
  caption="Negative margins allow users to scroll right"
/>
