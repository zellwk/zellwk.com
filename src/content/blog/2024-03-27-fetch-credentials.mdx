...
description: What do omit, same-origin, and include actually do? I ran experiments to find out exactly which cookies Fetch sends across domains and subdomains.
