...
description: 'Change Modular Scale ratio at breakpoints: Different ratios for viewports. Better typography.'
...
<Image
  src="/src/assets/2016/changing-ms-ratio/modular-scale-steps.png"
...
- Step 2: 16px _ 1.333 _ 1.333 = `28.43px`
...
<Image
  src="/src/assets/2016/changing-ms-ratio/change-ratio.gif"
  alt="Changing Ratio of Modular Scale"
/>
