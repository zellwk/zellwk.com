...
description: Variables in JavaScript: Const, let, var. Declare variables and choose the right keyword.
...
<Image
  src="/src/assets/2017/js-variables/const.png"
  alt="Reassigning a variable declared with const results in an error"
  caption="Reassigning a variable declared with const results in an error"
/>
...
<Image
  src="/src/assets/2017/js-variables/let.png"
  alt="It's okay to reassign variables declared with let"
  caption="It's okay to reassign variables declared with let"
/>
