...
<Image src="/src/assets/2021/prettier-standard/prettier.gif" alt="Markdown edited with Prettier" />

And here's one with Prettier Standard.

<Image src="/src/assets/2021/prettier-standard/prettier-standard.gif" alt="Markdown edited with Prettier Standard" />
