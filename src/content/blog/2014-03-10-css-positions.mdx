...
description: "How CSS positioning works — static, relative, absolute, and fixed — and when to use each one."
ckForm: css
tags: [css]
pubDate: 2014-03-10
---
...
<Image src="/src/assets/2014/03/posr.jpg" alt="position relative" />
...
<Image src="/src/assets/2014/03/posa.jpg" alt="position absolute" />

If there are no parent elements that has a relative position, then the absolutely
positioned element will take its reference from the browser window.
...
<Image src="/src/assets/2014/03/posf.jpg" alt="position fixed" />
