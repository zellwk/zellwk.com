...
description: 'Alter DOM with JavaScript: Select elements, add events, toggle classes, modify attributes, add/remove HTML.'
tags: [javascript]
...
<Codepen link="https://codepen.io/zellwk/pen/eWBLdZ" title='Altering DOM with JS demo' />
...
<Codepen link="https://codepen.io/zellwk/pen/aWBaME" title='Altering DOM with JS demo (Accessible way)' />
...
<Codepen
  link="https://codepen.io/zellwk/pen/EmNdWp"
