...
<Image src="/src/assets/2019/create-focus/combined.png" alt="Focus styles on Smashing Mag, WTF Forms and Slack" />
...
<Image src="/src/assets/2019/create-focus/smashing.png" alt="Focus styles on Smashing Magazine." />
```css
*:focus {
...
<Image src="/src/assets/2019/create-focus/wtf.png" alt="Focus styles for WTF Forms." />
...
<Image src="/src/assets/2019/create-focus/slack.png" alt="Focus styles on Slack." />
...
<Image src="/src/assets/2019/create-focus/double-borders.png" alt="" />
```css
button:focus {
