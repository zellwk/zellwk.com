...
pubDate: 2018-06-27
description: Get CSS values in JavaScript easily. Learn element.style and getComputedStyle methods to read inline, computed, and pseudo-element styles.
---
...
<Image
  src="/src/assets/2018/get-css/all-properties.png"
  alt="`getComputedStyle` returns an object that contains every CSS property and their respective values"
  caption="`getComputedStyle` returns an object that contains every CSS property and their respective values"
/>
...
<Image
  src="/src/assets/2018/get-css/firefox.png"
  caption="Firefox dev tools computed tab"
/>
...
<Image
  src="/src/assets/2018/get-css/chrome.png"
  caption="Chrome dev tools computed tab"
/>
