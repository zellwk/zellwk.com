...
description: How to identify and code the big-picture layout of a website using wrappers, headers, sidebars, and footers.
tags: [html, css]
pubDate: 2014-03-17
---
...
<Image src="/src/assets/2014/03/1.png" alt="HTML Header" />
...
<Image src="/src/assets/2014/03/1-1.png" alt="HTML Structure Header" />

Lets do the same for the footer as well

<Image src="/src/assets/2014/03/2.png" alt="Footer image" />

In this case, the obvious area are as follows

<Image src="/src/assets/2014/03/2-1.png" alt="HTML structure footer" />
...
<Image src="/src/assets/2014/03/3.jpg" alt="HTML structure 3" />
...
<Image src="/src/assets/2014/03/3-1.png" alt="html structure wraps" />

So effectively, the website structure should look something like this

<Image src="/src/assets/2014/03/3-2.jpg" alt="HTML structure 3.2" />
