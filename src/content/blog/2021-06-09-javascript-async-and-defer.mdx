...
pubDate: 2021-06-09
description: Master async and defer attributes for faster page loads. Discover when to use defer (most scripts) and async (independent scripts) with practical examples.
---
...
<Video src="/src/assets/2021/async-and-defer-attributes/after-script.mp4" />
...
<Video src="/src/assets/2021/async-and-defer-attributes/async.mp4" />
...
<Image
  src="/src/assets/2021/async-and-defer-attributes/number-of-elements.png"
  alt="Number of elements selected by async and defer"
/>
...
<Image
  src="/src/assets/2021/async-and-defer-attributes/async-sequence.png"
  alt="Loading order of async"
/>
...
<Image
  src="/src/assets/2021/async-and-defer-attributes/defer-sequence.png"
  alt="Loading order of defer"
/>
