...
tags: [gulp, nunjucks, html, tooling]
ckForm: ayw
pubDate: 2015-09-13
---
...
<Image src='/src/assets/2015/09/index-html-by-nunjucks.png' alt='' />
...
<Image src='/src/assets/2015/09/nav-partial.png' alt='' />
...
<Image src='/src/assets/2015/09/path-to-macros.png' alt='' />
...
{% import 'macros/nav-macro.nunjucks' as nav %} {% endblock %}
```
...
<div class="gallery">
  ...
  Now, if you run `gulp nunjucks`, you should get a `index.html` file with the
  following markup:
