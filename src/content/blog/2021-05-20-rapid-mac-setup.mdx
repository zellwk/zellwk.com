...
tags: [workstation]
pubDate: 2021-05-20
description: Set up a Mac for frontend development fast using dotfiles, SSH key backups, VS Code Settings Sync, and automated app installation tools.
---
...
<Image
  src="/src/assets/2021/rapid-mac-setup/trackpad-speed.png"
  caption="Trackpad speed settings"
/>

<Image
  src="/src/assets/2021/rapid-mac-setup/mouse-speed.png"
  caption="Mouse speed settings"
/>

Then I change the keyboard layout since [I use Dvorak Qwerty](https://zellwk.com/blog/dvorak/) as my main layout.

<Image
  src="/src/assets/2021/rapid-mac-setup/keyboard-layout-settings.png"
  alt="Keyboard layout settings"
/>
...
<Image
  src="/src/assets/2021/rapid-mac-setup/github-repo.png"
  alt="SSH configuration saved in Github repository"
/>
...
<Image
  src="/src/assets/2021/rapid-mac-setup/setapp.png"
  alt="Setapp favourite apps"
/>
...
<Image
  src="/src/assets/2021/rapid-mac-setup/twitter-post.png"
  alt="Zell twitter post"
/>
