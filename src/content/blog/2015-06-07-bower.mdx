...
<Image src="/src/assets/2015/06/bower-init.png" alt="bower init" />
...
<Image src="/src/assets/2015/06/jquery.png" alt="jquery folder" />

In this case, you'll want to search under `distribution`.

<Image src="/src/assets/2015/06/jquery-2.png" alt="jquery.js location" />
...
<Image src="/src/assets/2015/06/susy.png" alt="susy folder" />

<Image src="/src/assets/2015/06/susy-dep.png" alt="susy dependency" />
...
<Image src="/src/assets/2015/06/susy-2.png" alt="Susy sass file" />
...
<Image src="/src/assets/2015/06/bower-search.png" alt="breakpoint result" />
...
<Image
  src="/src/assets/2015/06/breakpoint-result.png"
  alt="breakpoint result"
/>
...
<Image
  src="/src/assets/2015/06/dependency-conflict.png"
...
<Image src="/src/assets/2015/06/bower-update.png" alt="bower-update" />

The only thing I dislike about the `bower-update` command is that it adds a "resolutions" object in the `bower.json` file.

<Image src="/src/assets/2015/06/bower-resolution.png" alt="bower resolution" />
