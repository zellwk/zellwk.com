...
<Image src="/images/2017/for-loop/zero-times.png" alt="Next line of code runs immediately since the condition evaluates to false" caption="Next line of code runs immediately since the condition evaluates to false" />
...
<Image src="/images/2017/for-loop/two-times.png" alt="The loop runs twice. After two times, the condition evaluates to false. " caption="The loop runs twice. After two times, the condition evaluates to false. " />
...
<Image src="/images/2017/for-loop/ten-times.png" alt="The loop runs twice. After ten times, the condition evaluates to false. " caption="The loop runs ten times. After ten times, the condition evaluates to false. " />
...
<Image src="/images/2017/for-loop/iterator.png" alt="Any object that contains the Symbol.iterator key can be iterated through with a for...of loop" caption="Any object that contains the Symbol.iterator key can be iterated through with a for...of loop" />
