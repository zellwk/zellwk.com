...
description: "Why border-box is the most useful CSS property for layouts, and how it saves you from constant width calculations."
ckForm: css
tags: [css]
pubDate: 2014-02-17
---
...
<Image src="/src/assets/2014/02/box-model.jpg" alt="Box Model" />
...
<Image src="/src/assets/2014/02/box-sizing.jpg" alt="box-sizing explanation" />
...
<Image
  src="/src/assets/2014/02/content-box-example.jpg"
  alt="Content-box example"
/>

<Image
  src="/src/assets/2014/02/border-box-example.jpg"
  alt="Border-box example"
/>
