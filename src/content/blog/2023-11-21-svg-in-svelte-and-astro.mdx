...
tags: [svelte, astro, html, svg, splendidlabz]
pubDate: 2023-11-21
---
...
Today I'm going to show you how the [SVG](https://splendidlabz.com/svelte/svg) utility from [Splendid UI](https://splendidlabz.com) works, and why it's the easiest way to use SVG to load both icons and custom graphics.
...
<Video
  gifReplacement
  src="/src/assets/blog/svg/loading-icons.mp4"
...
<Image
  src="/src/assets/blog/svg/iconify icon browser.png"
  caption="
Iconify icon browser"
/>

<Image
  src="/src/assets/blog/svg/iconify-icon-name.png"
...
And if you do, please consider checking out [Splendid UI](https://splendidlabz.com) and spreading the word about it. Thank you.

Edit: I've divided the `SVG` component to [`Icon`](https://splendidlabz.com/svelte/icon) and [`SVG`](https://splendidlabz.com/astro/svg). Please see their respective documentation accurate information.

## Further reading

- [Iconify](https://iconify.design)
- [Splendid UI](https://splendidlabz.com)
- [SVG component docs](https://splendidlabz.com/svelte/icon)
