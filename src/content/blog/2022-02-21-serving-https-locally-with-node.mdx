...
tags: [node, express]
pubDate: 2022-02-21
description: Serve HTTPS on localhost with Node.js. Use mkcert to generate certificates and configure Express for secure local development without external services.
---
