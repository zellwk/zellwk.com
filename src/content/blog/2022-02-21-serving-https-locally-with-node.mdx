...
tags: [node, express]
pubDate: 2022-02-21
description: Set up local HTTPS development with Node.js and mkcert. Generate trusted certificates for localhost and configure Express in minutes without external services.
---
...
<Image src="/src/assets/2022/node-https-localhost/generate-certs.png" alt="" />

I like to put these files in a `certs` folder and rename them into `key.pem` and `cert.pem` to keep things tidy.

<Image src="/src/assets/2022/node-https-localhost/rename-certs.png" alt="" />
...
<Image src="/src/assets/2022/node-https-localhost/demo.png" alt="" />
