...
<Image src="/images/2019/publish-to-npm/npm-login.png" alt="Logging into npm via the command line"/>
...
<Image src="/images/2019/publish-to-npm/npm-init.png" alt="Image of the npm init command"/>
...
<Image src="/images/2019/publish-to-npm/npm-publish-error.png" alt=""/>
...
<Image src="/images/2019/publish-to-npm/renaming.png" alt="Changed name property to publishing-to-npm"/>
...
<Image src="/images/2019/publish-to-npm/npm-publish.png" alt="Successfully published to npm"/>
...
<Image src="/images/2019/publish-to-npm/semver.png" alt="npm packages follows Semver"/>

Fourth, each update to React has a git tag associated with it. This git tag follows Semver as well.

<Image src="/images/2019/publish-to-npm/git-tag.png" alt="Each git tag is follows Semver"/>
...
<Image src="/images/2019/publish-to-npm/np-error-no-git.png" caption="np's error if project is not a Git repository"/>

If your project doesn't have remote, you'll get this error (at a later part of the checks).

<Image src="/images/2019/publish-to-npm/np-error-no-remote.png" caption="np's error if project does not have a remote. This error happens later in the process"/>

If your working directory is dirty, you'll get this error:

<Image src="/images/2019/publish-to-npm/np-error-dirty.png" caption="np's error working directory is dirty"/>
...
<Image src="/images/2019/publish-to-npm/np.png" alt="np prompts the user for a Semver number"/>

Choose a number and `np` will ask you to confirm your choice.

<Image src="/images/2019/publish-to-npm/np-confirm.png" alt="np prompts a confirmation of the chosen Semver number"/>
...
<Image src="/images/2019/publish-to-npm/np-test-error.png" alt="An error with running tests"/>
...
<Image src="/images/2019/publish-to-npm/npm-test-error.png" alt="npm test results in an error"/>
...
<Image src="/images/2019/publish-to-npm/np-process.png" alt="The np publishing process"/>

At the end of the process, `np` launches a browser window for you to write your release notes.

<Image src="/images/2019/publish-to-npm/np-release.png" alt="Writing release notes"/>
