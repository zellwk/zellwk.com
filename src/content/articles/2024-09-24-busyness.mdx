...
Interestingly, there is another character that contains both 心 and 亡. That character is 忘 (wàng).

忘 (wàng) means forget in English. But the character combination, 亡 followed and 心, suggests the heart is dead.

Related to this is 死心 (si xin).

死 means die.

死心 is usually used to as an expression for “giving up”. The close relation to 忘 (or 亡心) also suggests that one forgets when they give up on something.
